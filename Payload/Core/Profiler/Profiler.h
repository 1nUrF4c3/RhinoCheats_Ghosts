...
namespace RhinoCheats
{
	...
	public:
		...
		std::shared_ptr<sCvar> gTargetAgents = std::make_shared<sCvar>("Target Agents", std::vector<std::string>(), false, FALSE, TRUE);
		std::shared_ptr<sCvar> gTargetMissiles = std::make_shared<sCvar>("Target Missiles", std::vector<std::string>(), false, FALSE, TRUE);
		...
		std::shared_ptr<sCvar> gAgents = std::make_shared<sCvar>("Agents", std::vector<std::string>(), false, FALSE, TRUE);
